...
public class MeasurementKey
{
    ...
    /// <summary>
    /// Gets the <see cref="MeasurementMetadata"/> as they appear in the primary adapter metadata.
    /// </summary>
    /// <remarks>
    ...
    public static MeasurementKey CreateOrUpdate(Guid signalID, string source, ulong id)
    {
        ...
        MeasurementKey addValueFactory(Guid guid)
        {
