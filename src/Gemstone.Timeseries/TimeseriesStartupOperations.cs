...
public static class TimeseriesStartupOperations
{
    ...
    private static void ValidateStatistics(AdoDataConnection database)
    {
        ...
        const string StatHistorianInsertFormat = "INSERT INTO Historian(Acronym, Name, AssemblyName, TypeName, ConnectionString, IsLocal, Description, LoadOrder, Enabled) VALUES('STAT', 'Statistics Archive', 'openHistorian.Adapters.dll', 'openHistorian.Adapters.LocalOutputAdapter', 'ArchiveDirectories=Statistics; MaximumArchiveDays=90; DesiredRemainingSpace=0.1; ArchiveCurtailmentInterval=21600; DataChannel={port=38403; interface=::0}', 1, 'Local historian used to archive system statistics', 9999, 1)";
