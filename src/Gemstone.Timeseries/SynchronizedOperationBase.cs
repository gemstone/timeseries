    ...
    // : ISynchronizedOperation
{
    ...
    public static implicit operator SynchronizedOperationBase(Threading.SynchronizedOperations.LongSynchronizedOperation v)
    {
