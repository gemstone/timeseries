...
public static class IClientSubscriptionExtensions
{
    ...
    public static IaonSession CreateTemporalSession(this IClientSubscription clientSubscription)
    {
        ...
        clientSubscription.InputMeasurementKeys = [MeasurementKey.Undefined];
        clientSubscription.OutputMeasurements = [Measurement.Undefined];
        ...
        // to enable adapters that are connect-on-demand in the temporal session, we must make sure the proxy adapter is set up to
